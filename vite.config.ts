...
// Fix: __dirname is not available in ESM modules. We define it using import.meta.url.
...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      define: {
        ...
        'process.env.GITHUB_TOKEN': JSON.stringify(env.NEXT_PUBLIC_GITHUB_TOKEN || env.GITHUB_TOKEN),
      },
      resolve: {
        alias: {
